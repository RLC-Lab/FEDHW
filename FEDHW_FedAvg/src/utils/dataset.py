...
def split_dataset(train_dataset, test_dataset, client_number):
    block_length = int(len(train_dataset) / client_number)  # block_length is the number of datas in each client.
    # train_users is a dict, the key is the client id, the value is the index of the data in the client.S
